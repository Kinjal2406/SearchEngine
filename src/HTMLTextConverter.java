...
public class HTMLTextConverter {
	...
	//This method converts HTML Files into text documents.
		public static void convertHtmlToText()
			...
			try {
				File dir = new File("C:\\Users\\Sai.HP\\eclipse-workspace\\Search_Engine_21\\Test\\");
				...
				for (File file1 : file_Array) {
					...
					my_out = new BufferedWriter(
							new FileWriter("C:\\Users\\Sai.HP\\eclipse-workspace\\Search_Engine_21\\ConvertedTextFiles\\"
									+ my_str  + ".txt"));
