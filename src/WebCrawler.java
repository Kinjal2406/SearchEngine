	    ...
	    public void saveUrl(final String filename, final String urlString)
	    	...
	    	{ 
	            try { 
	                ...
	                BufferedReader my_readr =  
	                  new BufferedReader(new InputStreamReader(url.openStream())); 
	      
	                // Enter filename in which you want to download 
	                String str = filename +".html";
	               
	                BufferedWriter my_writer =  
	                  new BufferedWriter(new FileWriter("C:\\Users\\Sai.HP\\eclipse-workspace\\Search_Engine_21\\Test\\"+str)); 
	        ...
	        new WebCrawler().get_page_links("https://www.google.com",1000);
	    }
}
